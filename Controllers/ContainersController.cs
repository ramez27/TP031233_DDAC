...
namespace CMS.Controllers
{
    ...
    public class ContainersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContainerID,ContainerName,ContainerHeight,ContainerWidth,ContainerLength,ContainerWeight")] Container container)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContainerID,ContainerName,ContainerHeight,ContainerWidth,ContainerLength,ContainerWeight")] Container container)
        {
            if (ModelState.IsValid)
            {
